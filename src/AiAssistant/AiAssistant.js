    ...
    return (
        ...
        <div className="container" id="headerbox">
          ...
          <div className="jumbotron p-3 p-md-5 text-white rounded" id="shopping">
              <div className="col-md-6 px-0">
                <h1 className="display-4">AI Assistant</h1>
                <p className="lead my-3"> Fully automated AI shopping assistant that processeses promotional data from Sephora, Ulta, and Macy's to recommend products based on certain demographics</p>
        ...
        <div className="container my-3 py-2" id="chartbox" >
          <div className="card-deck mt-3 mb-3 gx-5 px-5 text-center">
            ...
            <div className="card mb-4 box-shadow">
              <div className="card-header"> <h4 className="lead my-1">Response</h4> </div>
